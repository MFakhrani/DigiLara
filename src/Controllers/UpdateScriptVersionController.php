...
namespace Fakhrani\Digilara\Controllers;

use Fakhrani\Digilara\Helpers\Reply;
...
class UpdateScriptVersionController extends Controller
{
    ...
    {
        return config('fakhrani_digilara.allow_users_id');
    }
    ...
    */
    ...
    public function install()
    {
        ...
        $update_path = config('fakhrani_digilara.tmp_path') . '/' . $archive;
    ...
    */
    ...
    public function updateDatabase()
    {
        ...
        return 'Database updated successfully. <a href="' . route(config('fakhrani_digilara.redirectRoute')) . '">Click here to Login</a>';
    }
    ...
    public function clearCache()
    {
        ...
        return 'Cache cleared successfully. <a href="' . route(config('fakhrani_digilara.redirectRoute')) . '">Click here to Login</a>';
    }
    ...
    public function refreshCache()
    {
        ...
        return 'Cache refreshed successfully. <a href="' . route(config('fakhrani_digilara.redirectRoute')) . '">Click here to Login</a>';
    }
}
